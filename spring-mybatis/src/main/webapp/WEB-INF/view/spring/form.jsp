    ...
    <form:form  modelAttribute="urlEncodedForm" class="col s12" action="/form" method="post">
        <div class="row">
            <div class="input-field col s7 ">
                ...
                <form:input path="userId" id="userId" name="userId" type="text" placeholder="userId" class="validate" />
            ...
            <div class="input-field col s7 ">
                ...
                <form:input path="email" id="email" name="email" type="email" placeholder="email" class="validate" />
                <form:errors path="email" cssClass="helper-text"/>
            </div>
            <div class="input-field col s7 ">
                <i class="material-icons prefix">phone</i>
                <form:input path="tel" id="tel" name="tel" type="tel" placeholder="tel" class="validate" />
